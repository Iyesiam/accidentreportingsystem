      ...
      <!-- partial -->
        <div class="content-wrapper">
          ...
          <div class="card-body">
            ...
            <form class="forms-sample" action="update.php?id=<?php echo $id; ?>" method="POST">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control" name="phone" id="phone" placeholder="Mobile number" value="<?php echo $phone; ?>">
                </div>
              </div>
              <div class="form-group row">
