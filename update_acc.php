...
// Retrieve the accident data for prepopulation
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updatedSeverity = $_POST['severity'];
    $updatedCity = $_POST['city'];
    $updatedDescription = $_POST['description'];

    // Update the accident record
    $updateSql = "UPDATE accidents SET datetime=?, location=?, severity=?, city=?, description=? WHERE id=?";
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
        <h4 class="card-title">Update Accident</h4>
        <form class="mt-4" action="update_acc.php?id=<?php echo $id; ?>" method="POST">
      <div class="form-group">
        <label for="datetime">Date and Time</label><label for="exampleInputName1">Date and Time</label>
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="severity" id="severity" required>
          <option value="Minor" <?php if ($severity == 'Minor') echo 'selected'; ?>>Minor</option>
          <option value="Moderate" <?php if ($severity == 'Moderate') echo 'selected'; ?>>Moderate</option>
          <option value="Severe" <?php if ($severity == 'Severe') echo 'selected'; ?>>Severe</option>
        </select>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="description" id="description" rows="4"><?php echo htmlspecialchars($description); ?></textarea>
      </div>
